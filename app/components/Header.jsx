      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full'>
        ...
        <div className='text-center lg:text-left'>
          <motion.h3
            ...
            className='flex items-center justify-center lg:justify-start gap-2 text-lg md:text-xl mb-4 font-Ovo'>
            Hi! I'm <Image src={assets.hand_icon} alt=''
          ...
          <motion.h1 
            ...
            className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-Ovo mb-6'>
            Vamsi Krishna Maram
          </motion.h1>
          ...
          <motion.h2 
            ...
            className='text-xl sm:text-2xl md:text-3xl font-Ovo min-h-[50px] flex items-center justify-center lg:justify-start'>
